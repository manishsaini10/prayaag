...
class PopupBuilderServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Register sidebar in admin
        $this->registerAdminMenu();
    }

    private function registerAdminMenu(): void
    {
        // Hook into existing admin menu system
        // This integrates with the admin sidebar navigation
        Event::listen('admin.menu.ready', function ($menu) {
            $menu->add('Popup Builder', [
                'route' => 'admin.popup-builder.dashboard',
                'icon' => 'template',
                'order' => 30,
                'children' => [
                    ['label' => 'Dashboard', 'route' => 'admin.popup-builder.dashboard', 'icon' => 'chart-bar'],
                    ['label' => 'All Popups', 'route' => 'admin.popup-builder.dashboard', 'icon' => 'collection'],
                    ['label' => 'Create Popup', 'route' => 'admin.popup-builder.create', 'icon' => 'plus-circle'],
                    ['label' => 'Templates', 'route' => 'admin.popup-builder.templates', 'icon' => 'template'],
                    ['label' => 'A/B Testing', 'route' => 'admin.popup-builder.ab-testing', 'icon' => 'beaker'],
                ],
            ]);
        });
    }
