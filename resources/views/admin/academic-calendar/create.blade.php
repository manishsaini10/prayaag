...
@section('title', 'New Calendar Entry')
@section('subtitle', 'Add exams, holidays, vacations, or PTM dates to the school academic calendar.')
...
<div x-data="{
    ...
    autoColor() {
        if (this.category === 'exam') { this.color_tag = 'red'; this.is_working_day = true; }
        else if (this.category === 'holiday') { this.color_tag = 'yellow'; this.is_working_day = false; }
        else if (this.category === 'important_date') { this.color_tag = 'blue'; this.is_working_day = true; }
        else { this.color_tag = 'grey'; this.is_working_day = true; }
    }
}" x-init="autoColor()">
    ...
    <div style="display:grid;grid-template-columns: 2fr 1fr;gap:24px;align-items:start">
        ...
        <div class="card" style="padding:24px">
            <form method="POST" action="{{ route('admin.academic-calendar-entries.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px">
                    <div class="form-group">
                        ...
                        <select name="category" x-model="category" @change="autoColor()" required style="width:100%;padding:10px 12px;border:1px solid #cbd5e1;border-radius:6px;font-size:14px;background:#fff">
                ...
                <div class="form-group" style="margin-bottom:20px">
                    ...
                    <textarea name="description" placeholder="Write calendar event details..." style="width:100%;height:100px;padding:10px 12px;border:1px solid #cbd5e1;border-radius:6px;font-size:14px;font-family:inherit;resize:vertical"></textarea>
                </div>
