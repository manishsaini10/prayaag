...
@section('subtitle', 'Initialize a new academic school year session.')
...
<div class="card" style="padding:24px;max-width:600px">
    <form method="POST" action="{{ route('admin.academic-sessions.store') }}">
        ...
        <div class="form-group" style="margin-bottom:20px">
            ...
            <input type="text" name="session_name" placeholder="e.g. 2026-2027" required style="width:100%;padding:10px 12px;border:1px solid #cbd5e1;border-radius:6px;font-size:14px">
        </div>
