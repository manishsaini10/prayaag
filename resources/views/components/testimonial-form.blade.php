<div class="relative bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden" x-data="testimonialForm()">
    ...
    <h3 class="text-2xl font-black text-gray-800 tracking-tight mb-1 flex items-center gap-2">
        <span>❤️</span> Share Your Experience
    </h3>
    <p class="text-xs text-gray-400 mb-6 font-medium leading-relaxed">
        Let us know your feedback! Your values and stories help other parents discover the vibrant Prayaag International School community.
    </p>

    {{-- Alerts with Micro-animations --}}
    <div x-show="success" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="flex gap-3 p-4 mb-5 rounded-2xl text-xs font-semibold text-emerald-800 bg-emerald-50 border border-emerald-100" x-cloak>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" class="w-4 h-4 shrink-0 mt-0.5"><path d="M20 6 9 17l-5-5"/></svg>
        <span x-text="message"></span>
    </div>
    
    <div x-show="errors.length" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="p-4 mb-5 rounded-2xl text-xs font-semibold text-rose-800 bg-rose-50 border border-rose-100" x-cloak>
    ...
    <form @submit.prevent="submitForm" class="space-y-5" enctype="multipart/form-data">
        ...
        <div class="bg-gray-50/50 p-4 rounded-2xl border border-gray-100 space-y-4">
            <h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">1. Your Profile</h4>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                {{-- Parent Name --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Parent Name *</label>
                ...
                {{-- Phone --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Phone Number *</label>
                ...
                {{-- Relationship --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Relationship</label>
                ...
                {{-- Email --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Email Address</label>
                ...
                {{-- Child's Name --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Child's Name</label>
                ...
                {{-- Child's Class --}}
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Child's Class</label>
        ...
        <div class="bg-gray-50/50 p-4 rounded-2xl border border-gray-100 space-y-4">
            <h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">2. Your Message & Review</h4>
            
            {{-- Title --}}
            <div>
                <label class="block text-[11px] font-bold text-gray-500 mb-1">Headline / Title</label>
            ...
            {{-- Experience --}}
            <div>
                <label class="block text-[11px] font-bold text-gray-500 mb-1">Your Detailed Experience *</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                ...
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Star Rating</label>
                ...
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 mb-1">Upload Photo</label>
                    ...
                    <div @click="$refs.fileInput.click()" class="relative flex items-center justify-center border-2 border-dashed border-gray-200 hover:border-purple-500 hover:bg-purple-50/20 transition-all duration-200 rounded-xl p-3 text-center cursor-pointer bg-white">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-semibold text-gray-500" x-text="photoFile ? photoFile.name : 'Choose Parent Photo'"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <label class="flex items-start gap-2.5 cursor-pointer">
            ...
            <span class="text-[10px] text-gray-400 font-medium leading-relaxed">
                I hereby declare that this testimonial is based on my first-hand experience, and I authorize the school administration to review, moderate, and publish it on the public school website.
            </span>
        </label>
