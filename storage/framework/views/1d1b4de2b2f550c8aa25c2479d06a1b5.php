...
<body>
            ...
            <div class="pb-row">
                <div class="pb-col pb-col--12" style="text-align:center" data-reveal>
                    ...
                    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
                        <a class="btn btn-gold" href="<?php echo e(url('/')); ?>">Back to Home</a>
                        <a class="btn btn-outline" href="<?php echo e(url('/search')); ?>">Search the Site</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script src="<?php echo e(asset('site.js')); ?>" defer></script>
</body>
</html>
<?php /**PATH F:\school-website\resources\views/errors/404.blade.php ENDPATH**/ ?>